...
const HomePage = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center bg-black py-12">
      ...
      <div
        className="text-center bg-cover bg-center p-12 rounded-lg shadow-lg mb-12 w-3/4 transition-transform duration-300 transform hover:scale-105 hover:shadow-xl"
        style={{
          backgroundImage:
      ...
      <div className="mt-12 w-full flex flex-col md:flex-row gap-6 justify-center">
        ...
        <div className="bg-gray-800 p-8 rounded-lg shadow-md flex-1 max-w-sm relative border-2 border-black backdrop-blur-md transition-transform duration-300 transform hover:scale-105 hover:shadow-lg">
          ...
          <p className="text-gray-300">
            Welcome to PIV Movies Promotion! Our website is designed for movie
            enthusiasts and casual viewers alike. Here, you can explore a
            comprehensive database of the latest movie releases, read insightful
            reviews, and discover upcoming events in the film industry. Whether
            you are looking for the next blockbuster hit or an indie gem, our
            curated lists and articles provide all the information you need.
            Additionally, we offer trailers and sneak peeks to keep you informed
            and excited. Join us to enhance your movie-watching experience and
        ...
        <div className="bg-gray-800 p-8 rounded-lg shadow-md flex-1 max-w-sm relative border-2 border-black backdrop-blur-md transition-transform duration-300 transform hover:scale-105 hover:shadow-lg">
          ...
          <p className="text-gray-300">
            The primary aim of PIV Movies Promotion is to create a vibrant
            community for movie lovers. We strive to provide a platform that not
            only informs but also engages users in discussions about films. By
            offering detailed information about movie releases, cast, and
            production details, we want to empower our audience to make informed
            choices about what to watch. Furthermore, we aim to support
            filmmakers and the film industry by promoting upcoming projects and
            events. Our goal is to foster a love for cinema and provide a space
            where fans can come together to celebrate their passion for movies.
          </p>
        </div>
      </div>
    </section>
